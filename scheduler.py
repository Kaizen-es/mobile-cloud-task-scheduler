...
Implementation of the MCC task scheduling algorithm from:
Lin, X., Wang, Y., Xie, Q., & Pedram, M. (2014)
...
Two-phase algorithm:
1. Initial scheduling - minimizes application completion time
2. Task migration - reduces energy consumption under time constraints
"""
